...
import { editSection, getDetailSection } from "../../../services/admin/sectionSevice";
...
function EditSection() {
        ...
        const formInitialValues = async () => {
            if (Object.keys(section).length > 0) {
                if (section.status === "active") {
                    section.status = true;
                } else if (section.status === "inactive") {
    ...
    const handleSubmit = async (data) => {
        ...
        const result = await editSection(courseId, sectionId, data);
        if (result.code === 200) {
    ...
    return (
        <>
            {permissions.includes("sections_edit") ? (
                        ...
                        <Row>
                            <Col xs={24}>
                                ...
                                >
                                    ...
                                    <Form.Item>
                                        <Button style={{ backgroundColor: '#20d489', color: '#fff' }} htmlType="submit" >Chỉnh sửa</Button>
                                    </Form.Item>
                                </Form>
                            </Col>
                        </Row>
                ...
                <div>Không được cấp quyền chỉnh sửa chương</div>
            )}
        </>
    );
};
