                    ...
                    {content.type === "quiz" && (
                        <div className="content__body">
                            <div className="content__item">
                                ...
                                <span className="content__content">{content?.totalQuestions || 0}</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Thời gian làm bài: </span>
                                <span className="content__content">{content?.duration || 0}</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Số lần làm bài tối đa: </span>
                                <span className="content__content">{content?.maxAttempts || 0}</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Số lần đã làm bài: </span>
                                <span className="content__content">{content?.attempt || 0}</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Số câu đã trả lời: </span>
                                <span className="content__content">{content?.totalAnswers || 0}</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Đáp án đúng: </span>
                                <span className="content__content">{content?.correctCount || 0}</span>
                            </div>
                            ...
                            <div className="content__item">
                                ...
                                <span className="content__content">{content?.percentageScore || 0}%</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Thời gian bắt đầu: </span>
                                <span className="content__content">{moment(content?.startTime).format('DD/MM/YYYY hh:mm A')}</span>
                            </div>

                            <div className="content__item">
                                <span className="content__label">Thời gian hết hạn: </span>
                                <span className="content__content">{moment(content?.endTime).format('DD/MM/YYYY hh:mm A')}</span>
                            </div>

                            <div className="content__button-quiz">
                                <Row gutter={[20, 20]}>
                                    <Col>
                                        <Button size="large" variant="filled" color="primary">Xem lại đáp án</Button>
                                    </Col>
