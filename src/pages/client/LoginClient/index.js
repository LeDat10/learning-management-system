            ...
            <div className="login-client">
                <Row style={{ height: "100%" }}>
                    <Col lg={12} md={24} sm={24} xs={24}>
                        <div className="login-client__inner-content">
                            <div className="login-client__content">
                    ...
                    <Col lg={12} md={0} sm={0} xs={0}>
                        <div className="login-client__inner-image">
                            <img className="login-client__image" src={lmsImage} />
                        </div>
                    </Col>
                </Row>
            </div>
