...
import FigureDot from "./FigureDot";
import { Col, Row } from 'antd';
import banner from "../../../images/pngtree-flat-design-online-courses-and-get-certificate-concept-png-image_14870057.png";
                                ...
                                <div className="banner__content">
                                    ...
                                    <div className="banner__benifits">
                                        <Row gutter={[0, 16]} align="middle" justify="center">
                                            ...
                                            <Col xs={12} sm={8} md={8} lg={8} xl={8} xxl={8}>
                                                <div>
                                                    <span className="banner__icon"><CheckCircleFilled /></span> Các bài kiểm tra
                                                </div>
                                            </Col>

                                            <Col xs={12} sm={8} md={8} lg={8} xl={8} xxl={8}>
                                                <div>
                                                    <span className="banner__icon"><CheckCircleFilled /></span> Hoàn toàn miễn phí
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
